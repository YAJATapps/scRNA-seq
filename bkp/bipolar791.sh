...
# The out.csv converted from tsv file
csv2bin(csvfile="/home/yajatapps3/out.csv", binfile="/home/yajatapps3/out.zst")

# Summary of data
# The Data.zst converted from csv
sumr(binfile="/home/yajatapps3/out.zst", outdir=tmp)
...
group=vcat(repeat(["group1"],inner=33), repeat(["group2"],inner=33), repeat(["group3"],inner=34))


# Algorithm971
out_algorithm971 = algorithm971(input="/home/yajatapps3/out.zst",
